# aim: to print total numbers in the first ten triangles
# Procedure:
# 1.initialize the sum and the number of triangle
# 2.extract first ten triangles
# 3.calculate the total numbers of each of them
